...
const TOPICS: Topic[] = [
  ...
  {
    id: 'india-grid-intensity',
    title: "India's Electricity Grid Factor",
    category: 'Indian Energy Context',
    description: "Learn about the carbon footprint of India's electricity generation and why shifting to clean power is crucial.",
    icon: Zap,
    details: [
      "India's electricity grid is heavily coal-dependent, emitting approximately 0.82 kg CO₂ per kWh as of 2023.",
      "This grid intensity means that electricity consumption in India is more carbon-intensive than in countries with nuclear or hydro-dominated power grids.",
      "Transitioning to solar power, clean biomass, and wind energy is key to achieving India's target of net-zero emissions by 2070."
    ],
    impact: "Because of the 0.82 kg/kWh grid factor, saving 100 kWh of energy in India prevents a substantial 82 kg of CO₂ emissions.",
    action: 'Shift high-load appliance usage to solar peak hours, utilize energy-efficient LED lighting, and consider rooftop solar panels.'
  },
  {
    id: 'india-vs-global-footprint',
    title: 'India per Capita vs. Global Average',
    category: 'Indian Emissions Context',
    description: "Compare India's average per capita carbon emissions with the global baseline to understand individual impact boundaries.",
    icon: Globe,
    details: [
      "An average citizen in India produces about 1.9 tons of CO₂ per year, which is significantly lower than the global average of 4.7 tons.",
      "This is primarily due to traditional low-waste eating habits, extensive usage of public transit, and a lower level of raw material consumption.",
      "However, as urbanization and standard of living rise, retaining sustainable habits is critical to prevent individual footprints from reaching Western levels (e.g. US: ~14.5t)."
    ],
    impact: "India is the world's third largest emitter overall, yet its per capita footprint (1.9t) remains less than half of the global average (4.7t).",
    action: 'Maintain a plant-forward diet, minimize single-use deliveries, and support community-led green spaces.'
  },
  {
    id: 'mumbai-local-trains',
    title: 'Mumbai Local Trains: Mass Transit Impact',
    category: 'Indian Transit Context',
    description: "Explore the massive carbon offset generated by Mumbai's suburban rail network, the lifeline of the city.",
    icon: Navigation,
    details: [
      "Mumbai's local train network carries over 7.5 million commuters daily, operating as one of the most carbon-efficient transit networks globally.",
      "By keeping millions of commuters out of private cars and taxis, it prevents approximately 100,000 tons of CO₂ emissions every single year.",
      "Choosing suburban rail or metro networks in Indian metropolitan cities drastically cuts local air pollution and urban greenhouse gas concentration."
    ],
    impact: "Mumbai local rail transit prevents vehicle idling in monsoon gridlocks, saving millions of liters of fossil fuel and preventing major smog spikes.",
    action: 'Choose Mumbai locals, metro corridors, or electric bus lines over private taxi hailing services for your daily commute.'
  }
];
